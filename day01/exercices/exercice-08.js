...
console.log((10 == "10")); //retourner true car les deux nombres sont egaux
console.log((10 === "10")); // retourner false car les deux valeur n'avont pas la meme type (un nombre et un string)
