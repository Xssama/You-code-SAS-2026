...
let achats_prix = 1;
let CoutFinal = achats_prix;
let Livraison_gratuite = false;
let Reduction = 0.10;
...
if (achats_prix >= 200)
{
    ...
    if(achats_prix >= 500)
    {
        CoutFinal = achats_prix * (1-Reduction)
    }
}
else
{
...
console.log("Livraision : ", (Livraison_gratuite == true ? "Gratuite":"A Payer"))
console.log("Cout Final: ", CoutFinal)
